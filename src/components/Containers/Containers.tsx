  ...
  useEffect(() => {
    const fetchRepos = async () => {
      try {
        ...
        setActiveCount(
          allContainers.filter((container) => container.status === "up").length
        );
        setSuspendedCount(
          allContainers.filter((container) => container.status !== "up").length
        );
        setFilteredContainers(allContainers); // Initially show all containers
      } catch (error) {
            ...
            return (
              <tr key={container.id}>
                <td className="text-center align-middle">
                  ...
                  <Link
                    to={"/containers/" + container.id + "/login"}
                ...
                <td className="text-center align-middle">Web Service</td>
                <td className="text-center align-middle">
                  <span className="badge bg-secondary">
                    Node {repo?.nodeVersion}
                  </span>
                </td>
                <td className="text-center align-middle">Egypt</td>
                <td className="text-center align-middle">
